...
public class All {
    ...
    public static final Integer INSERT_COUNT = Integer.parseInt((String) BeanFactory.getBean("insertCount"));
    public static final String INSERT_SQL = (String) BeanFactory.getBean("insertSql");
    /*Integer.parseInt((String) BeanFactory.getBean("onceCount"));*/
    ...
    public static void main(String[] args){
        ...
        try {
            ...
            while (rs1.next()) {
                ...
                pst2 = conn2.prepareStatement(INSERT_SQL);
                for(int i=0;i<INSERT_COUNT;i++){
                    ...
                    pst2.setLong(3*i+1, rs1.getLong(1));
                    pst2.setTimestamp(3*i+2, rs1.getTimestamp(2));
                    pst2.setLong(3*i+3, rs1.getLong(3));
                    if(rs1.next()){
                        if(i==0){
